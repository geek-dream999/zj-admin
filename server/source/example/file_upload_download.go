...
func (i *initExaFileMysql) MigrateTable(ctx context.Context) (context.Context, error) {
	...
	return ctx, db.AutoMigrate(&warehouse.ExaFileUploadAndDownload{})
}
...
func (i *initExaFileMysql) TableCreated(ctx context.Context) bool {
	...
	return db.Migrator().HasTable(&warehouse.ExaFileUploadAndDownload{})
}

func (i initExaFileMysql) InitializerName() string {
	return warehouse.ExaFileUploadAndDownload{}.TableName()
}
...
func (i *initExaFileMysql) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []warehouse.ExaFileUploadAndDownload{
	...
	if err := db.Create(&entities).Error; err != nil {
		return ctx, errors.Wrap(err, warehouse.ExaFileUploadAndDownload{}.TableName()+"表数据初始化失败!")
	}
	return ctx, nil
}
...
func (i *initExaFileMysql) DataInserted(ctx context.Context) bool {
	...
	lookup := warehouse.ExaFileUploadAndDownload{Name: "logo.png", Key: "1587973709logo.png"}
